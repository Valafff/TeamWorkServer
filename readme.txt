...
19.07.2024 - Добавлено логирование.
19.07.2024 - Добавлена работа через конфиг. Для корректной работы в конфиге надо настроить пути кдиректориям Data\Clients\,  Data\Dishes\, Data\Admins\! При удалении конфига директории создадуться в исходной папке приложения
